...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const flaskDisplay = document.getElementById("flasks");
    ...
    // Spell recognition (more refined logic)
    ...
    function updateUI() {
        ...
        manaDisplay.textContent = `Mana: ${playerMana}`;
        flaskDisplay.textContent = `Flasks: ${flasks}`;
    }
